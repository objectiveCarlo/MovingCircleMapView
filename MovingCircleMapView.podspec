#
# Be sure to run `pod lib lint MovingCircleMapView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/objectiveCarlo/MovingCircleMapView.git", :tag => "#{s.version}" }
  ...
  s.resource_bundles = {
    'MovingCircleMapView' => ['Pod/Assets/*.png']
  }
